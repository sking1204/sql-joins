...
--Count the number of cars for each owner and display the
--average price for each of the cars as integers. Display
-- the owners first_name , last_name, average price
